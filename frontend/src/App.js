...
import { Bell, MessageSquare, BookOpen, Users, PlusCircle, Google, Presentation, FileText, Video, Mic, Send } from 'lucide-react';
import './App.css';
    ...
    <div className="min-h-screen bg-gradient-to-br from-midnight-900 via-black to-midnight-800">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8 bg-midnight-800/50 backdrop-blur-lg border border-midnight-700">
